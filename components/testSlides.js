  ...
  return (
    <div>
      <div className="slides p-9 ">
        <div className="p-9 grid grid-cols-1 md:grid-cols-1 lg:grid-cols-1 gap-4 bg-white drop-shadow">
          <div className="p-4 ounded-md flex items-center justify-center">
            <Image src={props.image} width={200} height={200} />
          </div>
          <div className="rounded-md flex items-center justify-center bg-green-700">
          ...
          <div className="pt-1 pl-4 pr-4   rounded-md flex items-center justify-center">
            {props.post}
          </div>
          <div className=" pl-4 pr-4   rounded-md flex items-center justify-center">
            GOVERNMENT OF INDIA
