    ...
    <div>
      ...
      <div className="bg-white">
        <div className="islider">
          <span>
            <i>An invitation-only platform that shares cutting-edge ideas</i>
          </span>
          <br />
          <br />
        ...
        <div class="p-6 bg-white-300">
          <div class="grid grid-cols-3 md:grid-cols-3 lg:grid-cols-3 gap-1 lg:gap-1">
            <div class=" rounded-md flex items-center justify-center">
              <InfluencerSliderleft className="slide" />
            </div>
            <div class="  rounded-md flex items-center justify-center">
              <InfluencerSlider className="slide" />
            </div>
            <div class="  rounded-md flex items-center justify-center">
              <InfluencerSliderright className="slide" />
            </div>
          </div>
        </div>
        <br />
